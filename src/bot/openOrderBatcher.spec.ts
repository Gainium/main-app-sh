 ...
 *
 * Spec: `specs/076.kraken-spot-bulk-cancel-and-bulk-place.md` §7.
 * Run: `npm test` (mocha).
 *
...
describe('OpenOrderBatcher flush (spec 076 §7.3)', () => {
...
describe('OpenOrderBatcher delivery is one at a time (spec 076 §7.3)', () => {
...
describe('OpenOrderBatcher never parks a burst (spec 076 §7.4)', () => {
