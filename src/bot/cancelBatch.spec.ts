 ...
 *
 * Spec: `specs/076.kraken-spot-bulk-cancel-and-bulk-place.md` §3, §4.
 * Run: `npm test` (mocha).
 *
...
describe('primeCancelBatch (spec 076 §3)', () => {
...
describe('primeCancelBatch asks nobody it was not armed for (spec 076 §5)', () => {
